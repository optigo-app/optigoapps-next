    ...
    const industries = [
        {
            ...
            linkUrl: "/jewellery-mfg/industries/cz-manufacturing/"
        },
        {
            id: 2,
            ...
            linkUrl: "/jewellery-mfg/industries/bangles-manufacturing/"
        },
        {
            id: 3,
            ...
            linkUrl: "/jewellery-mfg/industries/kundan-jadau-manufacturing/"
        },
        {
            id: 4,
            ...
            linkUrl: "/jewellery-mfg/industries/handmade-jewellery/"
        },
        {
            id: 5,
            ...
            linkUrl: "/jewellery-mfg/industries/gold-jewellery-manufacturing/"
        },
        {
            id: 6,
        ...
        <section className="industry-grid" style={{ backgroundImage: 'url(/bg.webp)', backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: "no-repeat" }}>
            <div className="industry-grid__container">
                <div className="industry-grid__header">
                    ...
                    <a href='/jewellery-mfg/industries/all-industries/' onClick={(e) => handleNavigation(e, '/jewellery-mfg/industries/all-industries/')} className="industry-grid__view-all">
                        View all industries
