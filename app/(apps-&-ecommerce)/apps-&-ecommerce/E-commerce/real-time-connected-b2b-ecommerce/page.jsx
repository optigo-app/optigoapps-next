...
const page = () => {
   ...
   Jewellery distribution is complex – multiple dealers, different price levels, bulk orders, and custom product requirements. Managing this manually through calls and spreadsheets slows down your business. <strong>OptigoApps</strong> Jewellery Distribution Website empowers wholesalers and manufacturers to build a digital distribution network, where every dealer, sub-dealer, and retailer can place orders online with their own price levels, discounts, and credit terms – fully connected with ERP for real-time inventory, pricing, and order status.`;
    ...
    return (
        <>
            <Industries mainTitle={mainTitle} mainDescription={mainDescription} mainImg={'/ecom-3.jpg'} mainButtonContent={mainButtonContent} section={section} section7Title={section7Title} section7Data={section7Data} section2Title={section2Title} section2Data={section2Data} />
            ...
            <div className="b2b-wrapper left-content">
                <div className="b2b-text">
                    ...
                    <ul>
                        <li><Store size={18} /> Distributors and retailers log in to view products and place orders.</li>
                        <li><Wallet size={18} /> Each customer sees their own pricing and offers.</li>
                        <li><ClipboardList size={18} /> Orders sync automatically with ERP for stock, billing, and delivery.</li>
                        <li><ShieldCheck size={18} /> Complete control over visibility, pricing, and credit limits.</li>
                    </ul>
                </div>
            ...
            <div className="b2b-wrapper right-content">
                ...
                <div className="b2b-text">
                    ...
                    <ul>
                        <li><MessageCircle size={18} /> Reduce manual calls and WhatsApp follow-ups for orders.</li>
                        <li><Zap size={18} /> Eliminate errors in stock availability and pricing.</li>
                        <li><Globe size={18} /> Faster order processing across multiple regions.</li>
                        <li><ClipboardList size={18} /> Transparent access to live stock, invoices, and ledgers.</li>
                    </ul>
                </div>
            </div>
