...
import { AlertTriangle, CalendarCheck, CheckCircle, FileSignature, Handshake, LineChart, PackageSearch, Timer } from 'lucide-react';
...
const page = () => {
    ...
    const section4Data = [
        ...
        {
            content: "Ready to streamline your vendor management? Request a Demo Today!"
        },
    ]

    return (
        <>
            <Industries mainTitle={mainTitle} mainDescription={mainDescription} mainImg={'/vendor-1.jpg'} mainButtonContent={mainButtonContent} section={section} section7Title={section7Title} section7Data={section7Data} />
            ...
            <div className="vendor-wrapper left-content">
                <div className="vendor-text">
                    ...
                    <ul>
                        <li><Handshake size={18} /> Selecting and onboarding vendors</li>
                        <li><FileSignature size={18} /> Negotiating and managing contracts</li>
                        <li><Timer size={18} /> Controlling costs and ensuring timely delivery</li>
                        <li><AlertTriangle size={18} /> Reducing vendor-related risks</li>
                        <li><CheckCircle size={18} /> Maintaining quality consistency and compliance</li>
                    </ul>
                </div>
            ...
            <div className="vendor-wrapper right-content">
                ...
                <div className="vendor-text">
                    ...
                    <ul>
                        <li><PackageSearch size={18} /> For trading and wholesale businesses, efficient vendor management is the backbone of a robust supply chain.</li>
                        <li><CalendarCheck size={18} /> It ensures timely availability of materials, cost optimization, and quality assurance.</li>
                        <li><LineChart size={18} /> All of which contribute to improved operational efficiency and customer satisfaction.</li>
                    </ul>
                </div>
