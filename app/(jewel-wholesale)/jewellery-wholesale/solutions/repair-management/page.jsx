...
const page = () => {
    ...
    const section4Data = [
        ...
        },
        {
            ...
            description:
                "Notify customers automatically when their repaired items are ready for pickup or delivery.",
        }
    ];
    ...
    const section3Data = [
        ...
        {
            content: "Ready to simplify your repair management? Contact Optigo today!"
        },
    ]
    ...
    return (
        <>
            <Industries mainTitle={mainTitle} mainDescription={mainDescription} mainImg={'/repair.jpg'} mainButtonContent={mainButtonContent} section={section} section2Title={section2Title} section2Data={section2Data} section4Title={section4Title} sectiion4Data={section4Data} />
