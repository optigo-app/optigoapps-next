...
export const metadata = generatePageMetadata(pages['/jewellery-mfg/industries/bangles-manufacturing']);
...
const page = () => {
    ...
    const section7Data = [
        ...
        },
        {
            ...
            "points": [
                ...
                "Email order status reports directly to customers"
            ]
        }
    ];
    ...
    return (
        <>
            <Industries mainTitle={mainTitle} mainDescription={mainDescription} mainImg={'/bangle.jpg'} mainButtonContent={mainButtonContent} section={section} section2Title={section2Title} section2Description={section2Description} section2Data={section2Data} section7Title={section7Title} section7Data={section7Data} />
