...
export const metadata = generatePageMetadata(pages['/jewellery-mfg/industries/cz-manufacturing']);
...
const page = () => {
    ...
    const section7Data = [
        ...
        },
        {
            ...
            points: [
                ...
                "Auto-email status updates to your buyers or agents",
            ],
        },
        {
            id: 7,
    ...
    return (
        <>
            <Industries mainTitle={mainTitle} mainDescription={mainDescription} mainImg={"/cz.jpg"} mainButtonContent={mainButtonContent} section={section} section2Title={section2Title} section2Data={section2Data} section7Title={section7Title} section7Data={section7Data} />
