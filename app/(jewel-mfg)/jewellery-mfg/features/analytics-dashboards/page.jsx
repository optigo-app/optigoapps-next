...
export const metadata = generatePageMetadata(pages['/jewellery-mfg/features/analytics-dashboards']);
...
const page = () => {
    ...
    const section3Data = [
        ...
        {
            content: `Book a demo and experience insight-driven growth.`
        },
    ]

    return (
        <>
            <Industries mainTitle={mainTitle} mainDescription={mainDescription} mainImg={"/dashboard.jpg"} mainButtonContent={mainButtonContent} section={section} section7Titlei={section7Titlei} section7Datai={section7Datai} />
