...
export const metadata = generatePageMetadata(pages['/jewellery-mfg/features/all-features']);
...
const page = () => {
    ...
    return (
        <>
            <Industries mainTitle={mainTitle} mainDescription={mainDescription} mainImg={"/manu-features.jpg"} mainButtonContent={mainButtonContent} section={section} section7Title={section7Title} section7Data={section7Data} />
        </>
    );
};
