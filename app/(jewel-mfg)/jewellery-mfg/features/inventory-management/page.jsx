...
export const metadata = generatePageMetadata(pages['/jewellery-mfg/features/inventory-management']);
...
const page = () => {
    ...
    return (
        <>
            <Industries mainTitle={mainTitle} mainDescription={mainDescription} mainImg={"/invent-man.jpg"} mainButtonContent={mainButtonContent} section={section} section7Titlei={section7Titlei} section7Datai={section7Datai} />
