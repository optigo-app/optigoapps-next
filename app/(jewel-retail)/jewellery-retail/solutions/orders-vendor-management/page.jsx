...
const page = () => {
    ...
    const section4Data = [
        ...
        },
        {
            ...
            description: "5.Monitor raw materials still pending with vendors to align stock needs."
        },
        {
            icon: "🧾",
    ...
    const section3Data = [
        ...
        {
            content: "Request a Demo Today!"
        },
    ]

    return (
        <>
            <Industries mainTitle={mainTitle} mainDescription={mainDescription} mainImg={'/vendor-order.jpg'} mainButtonContent={mainButtonContent} section={section} section2Title={section2Title} section2Data={section2Data} section4Title={section4Title} sectiion4Data={section4Data} />
